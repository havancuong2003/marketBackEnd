...
export class HistoryTransController {
  constructor(
    ...
    private readonly historyTransService: IHistoryTransService,
  ) {}
  ...
  @Get(':id/top-trans')
  async getTopTrans(@Param('id') id: number, @Query('page') page: number) {
    return await this.historyTransService.getTopTrans(id, page);
  }
}
